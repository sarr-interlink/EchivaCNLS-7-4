...
use Dossiers\Form\SerologieForm;
...
//initialisation
		...
		$subFormMedicalBioSero = new SerologieForm();
        $subFormMedicalBioSero->setName('subFormMedicalBioSero');
		...
		$subFormMedicalBio->add($subFormMedicalBioSero);
