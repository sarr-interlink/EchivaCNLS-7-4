...
class Permission implements InputFilterAwareInterface {
    ...
    public function exchangeArray($data) {
        ...
        $this->permission_name = (isset($data['permission_name']) && !empty($data['permission_name']) ) ? $data['permission_name'] : null;
        $this->resource_id = (isset($data['resource_id']) && !empty($data['resource_id']) ) ? $data['resource_id'] : null;
