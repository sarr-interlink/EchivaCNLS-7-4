...
abstract class AbstractRecord extends AbstractValidator
{
    ...
    protected $messageTemplates = array(
        self::ERROR_NO_RECORD_FOUND => "Aucun enregistrement n'a été trouvé avec cette entrée",
        self::ERROR_RECORD_FOUND    => "Un enregistrement a été trouvé avec cette entrée",
    );
