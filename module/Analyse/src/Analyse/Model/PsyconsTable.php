...
class PsyconsTable {
	...
	public function Rapportjoint($where = null,$columns = null,$join=null,$condjoin=null,$group = null, $order = null, $limit = null) {
        $select = new \Zend\Db\Sql\Select($this->tableGateway->getTable());
         if ($where != null) {
            $select->where($where);
        }
	...
	public function getPsycons($Nume) {
        $Nume = (int) $Nume;
    ...
    public function deletePsycons($Nume) {
        $requete = "";
