...
class SocienfaTable {
	...
	public function getSocienfa($Nume) {
        $Nume = (int) $Nume;
    ...
    public function deleteSocienfa($Nume) {
        $requete = "";
